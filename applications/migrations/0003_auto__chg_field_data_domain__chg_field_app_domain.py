...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'applications_data', 'domain_id', self.gf('django.db.models.fields.related.ForeignKey')(default='test', to=orm['applications.Domain']))

        # Changing field 'App.domain'
        db.alter_column(u'applications_app', 'domain_id', self.gf('django.db.models.fields.related.ForeignKey')(default='test', to=orm['applications.Domain']))
