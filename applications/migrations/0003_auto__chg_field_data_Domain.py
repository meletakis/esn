...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Data.Domain'
        db.alter_column(u'applications_data', 'Domain_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['applications.Domain'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Data.Domain'
        raise RuntimeError("Cannot reverse this migration. 'Data.Domain' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Data.Domain'
        db.alter_column(u'applications_data', 'Domain_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['applications.Domain']))
