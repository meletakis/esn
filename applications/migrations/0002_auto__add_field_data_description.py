...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Data.description'
        db.add_column(u'applications_data', 'description',
                      self.gf('django.db.models.fields.TextField')(default='desc'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Data.description'
        db.delete_column(u'applications_data', 'description')
