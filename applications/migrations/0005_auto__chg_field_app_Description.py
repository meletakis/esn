...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'App.Description'
        db.alter_column(u'applications_app', 'Description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'App.Description'
        db.alter_column(u'applications_app', 'Description', self.gf('django.db.models.fields.CharField')(max_length=512))
