...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Data.Name'
        db.alter_column(u'applications_data', 'Name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Data.Name'
        db.alter_column(u'applications_data', 'Name', self.gf('django.db.models.fields.CharField')(max_length=50))
